		...
		<footer class="site-footer">
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/curve-footer.png" alt="" class="curve">
			<div class="container">
				<div class="row">
					<?php if(get_field('footer_logo', 'option')): ?>
						<div class="footer-logo">
							<img src="<?php echo get_field('footer_logo', 'option')['sizes']['small']; ?>" alt="">
						</div>
					<?php endif; ?>
					<div class="footer-content">
						<?php if(get_field('footer_title', 'option')): ?>
							<h3 class="title"><?php echo text_replace_brackets(get_field('footer_title', 'option')); ?></h3>
						<?php endif; ?>
						...
						<?php if($contact['social_media_links']): ?>
							<ul class="footer-social">
								<?php foreach ($contact['social_media_links'] as $social): ?>
									<?php 
										$social_site_name = $social['site']['label'];
										$social_site_class = $social['site']['value'];
										$social_site_url = $social['url'];
									?>
									<li>
